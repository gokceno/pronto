...
export const RemoveAllFavorites = ({type}) => {
    ...
    >
      ...
      <div className='flex flex-col'>
        ...
        <div className='w-full h-[4.5rem] flex flex-row justify-between items-center px-4'>
          ...
          <button className='px-4 transition-all hover:scale-105 rounded-[2rem] bg-[#DB0A3C] h-[2.5rem] gap-1 items-center justify-center w-auto min-w-[8rem]'>
