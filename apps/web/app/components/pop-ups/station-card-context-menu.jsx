...
export default function StationCardContextMenu({locale, onClose, onShare, stationuuid=""}) {
  ...
  return (
    <div className="w-[14.0625rem] h-[15rem] flex p-4 gap-3 bg-white flex-col shadow-lg rounded-xl">
      ...
      <div className='flex flex-col w-full gap-2'>
        ...
        <Link className='flex flex-col w-full h-8 py-1 px-2 hover:bg-[#E8F2FF] hover:rounded-lg transition-all'>
          <div className='w-full h-6 gap-1 flex flex-row items-center'>
            <img
