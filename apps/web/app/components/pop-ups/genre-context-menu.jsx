import { Share1Icon, EyeOpenIcon } from "@radix-ui/react-icons";

export const GenreContextMenu = ({ t, popupRef, onShare, onClose }) => (
  <div
    ref={popupRef}
    className="absolute top-full right-0 mt-2 w-[14.0625rem] h-auto bg-white rounded-xl p-4 gap-3 shadow-2xl drop-shadow-lg flex flex-col z-[9999]"
  >
    ...
    <div className="w-[12.0625rem] h-auto mt-1">
